from flask import request, render_template, redirect, url_for, current_app, make_response
...
def checkout():
    try:
        ...
        if not buyer_cookie or not return_url:
            current_app.logger.error("Buyer cookie or return URL not found in cookies")
